...
var $apiKey = 'AIzaSyB9-5hM4G8vWTxONiSeY0QwjFmG7-ZuJS0';
var imagemPerf;
var tabindex = 1;
var bannerview = 0;
var atualizamaptime;
    ...
    myApp.showIndicator();
        ...
        $.ajax({
            ...
            console.log("sindico");
                ...
                myApp.hideIndicator();
                myApp.alert('E-mail e/ou senha inválidos!', 'Conceito');
            }
...
$$('#esqueceu').on('click', function(){
    ...
    $.ajax($server+'functionAppMorador.php?', {
      ...
      .fail(function() {
        myApp.alert('Email não cadastrado.', 'Conceito');
      })     
      .done(function(data) {
            if (data=="ok") {
                myApp.alert('Email de recuperação de senha, enviado com sucesso!', 'Conceito');
...
function atualizartoken(data){
    setTimeout(function () {
        ...
        .fail(function() {
        //myApp.alert('Erro! Tente novamente.', 'Conceito');
        })     
        .done(function(data) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                myApp.hideIndicator();
                    ...
                    myApp.alert('Erro de conexão com o servidor! O App será fechado.', 'Conceito');
...
//console.log("profile");
    ...
    atualizartoken(localStorage.getItem("token"));
        ...
        //myApp.alert('Morador editado om sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'bannercont'});popupBanner();});
}
...
$$('.edit_profile').on('click', function(){
    ...
    $$url = $server+"functionAppProfile.php?guid="+$$guid+"&tipodeusuario="+$$tipoUsuario+"&action=list";
        ...
        $.ajax({
         ...
         ,error:function(data){
            myApp.hideIndicator();
            myApp.alert('Erro! Favor tentar novamente.', 'Conceito');
         }
        });
...
$('#buteditprofile').on('click', function(){
    ...
    if (($$('#profilenome').val()!="") &&  ($$('#profilecpf').val()!="" || $$('#profilecnpj').val()!="") && ($$('#profilephonenumber').val()!="")){
        ...
        myApp.alert('Preencha todos os campos.', 'Conceito');    
    }
});
        ...
        $.ajax({
         ...
         success: function(data){
            ...
            $$.each(data.profile, function (chave,dados)
            {
                ...
                myApp.hideIndicator();
                myApp.alert('Usuário editado om sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'index'});});
            });
        }
         ,error:function(data){
            myApp.hideIndicator();
        ...
        $.ajax($server+'functionAppPagseguro.php?', {
          ...
          .done(function(data) {
            ...
            if (data!="ok") {
                ...
                myApp.hidePreloader();
                myApp.alert('Pagamento realizado com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'pagamentos'}); pagamentos();});
            }
          });
}
...
function delanuncio(guid,eq){
    ...
    myApp.confirm('Deseja deletar esse item?', function () {
        ...
        $.ajax({
            ...
            if (data!="ok") {
                myApp.hideIndicator();
                myApp.alert('Erro! Tente novamente ='+data, 'Conceito');
            } else {
                myApp.hideIndicator();
        ...
        $.ajax($server+'functionAppAnuncios.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Anúncio inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'muraldeanuncios'}); muraldeanuncios();});
            }
          });
}
        ...
        $.ajax($server+'functionAppAlertaPortaria.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Alerta inserido com sucesso!', 'Conceito', function () { window.location = "index.html";});
            }
          });
}
...
function inserirocorrencias(){
        $.ajax({
            ...
            success: function(data) {
                ...
                myApp.hideIndicator();
                myApp.alert('Erro ao carregar dados, tente novamente!', 'Conceito', function () { mainView.router.load({pageName: 'livroocorrencias'}); livroocorrencias();});
            }
        });
}
...
$$('#pdfFileOcorrencias').on('change', function (e) {
    ...
    if (files[0].name.indexOf(".pdf")!=-1 || files[0].name.indexOf(".PDF")!=-1) {
        ...
        myApp.alert('Formato inválido! Escolha um arquivo no formato PDF.', 'Conceito');
    }
            ...
            $.ajax($server+'functionAppOcorrencia.php?', {
              ...
              .done(function(data) {
                if (data!="ok") {
                    ...
                    myApp.alert('Ocorrência inserida com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'livroocorrencias'}); livroocorrencias();});
                }
              });
            ...
            $.ajax($server+'functionAppTransparencia.php?', {
              ...
              .done(function(data) {
                if ((data!="ok") && (data!=" ok")) {
                    ...
                    myApp.alert('Transparência inserida com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'transparenciadecontas'}); transparenciadecontas();});
                }
              });
        }else{
        ...
        $.ajax($server+'functionAppServico.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Serviço inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'servico'}); servico();});
            }
          });
}
        ...
        $.ajax($server+'functionAppCronograma.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Equipe inserida com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'cronograma'}); cronograma();});
            }
          });
}
 ...
 //alert("entrei");
        ...
        $.ajax($server+'functionAppMorador.php?', {
          ...
          .done(function(data) {
            if (data=="ok") {
               myApp.hideIndicator();
                myApp.alert('Morador inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'morador'}); morador();});
            } else if (data=="erro"){
                myApp.hideIndicator();
                myApp.alert('Erro! Tente novamente.', 'Conceito');
            } else {
                myApp.hideIndicator();
                myApp.alert(data, 'Conceito');
            }
...
$$('#cadastro-teste').on('click', function(){
        ...
        $.ajax($server+'functionAppMorador.php?', {
          ...
          .done(function(data) {
            if (data=="ok") {
               myApp.hideIndicator();
                myApp.alert('Morador teste cadastrado com sucesso!<br><br>Você receberá um email de confirmação para criar sua senha (Caso não receba, verificar na pasta SPAM).', 'Conceito', function () { myApp.closeModal('.popup.modal-in');});
            } else if (data=="erro"){
                myApp.hideIndicator();
                myApp.alert('Erro! Tente novamente.', 'Conceito');
            } else {
    ...
    if (localStorage.getItem("portariaIdportaria")) {
        if (!$('#txtvisitantecondominio:checked').val()){
            if ($$('#blocolistportariavisitantes').val()=="" || $$('#domiciliolistportariavisitantes').val()=="") {
                myApp.alert('Selecione o Bloco e Apartamento.', 'Conceito');
            }else{
        ...
        if ($$('#txtnomevisitante').val()!="") {
            if (datatermino<datainicio) {
                myApp.alert('Data término deve ser maior que data início', 'Conceito'); 
            } else if (($$('#txthorainiciotempvisitante').val()!="") && ($$('#txthorainiciotempvisitante').val()==$$('#txthoraterminotempvisitante').val())) {
                 myApp.alert('Data início e término devem ser diferentes', 'Conceito'); 
            } else{
                enviarvisitante();
            }
        }else{
        ...
        $.ajax($server+'functionAppVisitante.php?', {
          ...
          .done(function(data) {
            if (data=="" || data =="erro") {
                ...
                myApp.hideIndicator();
                if (localStorage.getItem("portariaIdportaria")) {
                    myApp.alert('Visitante inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'index'});});
                }else{
                    myApp.alert('Visitante inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'visitante'}); visitante();});
                }
            }
          });
        ...
        $.ajax($server+'functionAppVisitanteAcesso.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                if (acesso=="entrada") {
                    myApp.alert('Entrada inserida com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'index'});});
                }else if (acesso=="saida") {
                    myApp.alert('Saída inserida com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'index'});});
                }
            }
          });
        ...
        $.ajax($server+'functionAppVeiculo.php?', {
          ...
          .done(function(data) {
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Veículo inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'veiculo'}); veiculo();});
            }
          });
}
    ...
    function listBloco(alvo){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                myApp.hideIndicator();
                myApp.alert('Erro ao carregar dados, tente novamente!', 'Conceito', function () { mainView.router.load({pageName: 'comuncondominio'}); comuncondominio();});
            }
        });
    }
            ...
            $.ajax($server+'functionAppComunCondominio.php?', {
              ...
              .done(function(data) {
                if ((data!="ok") && (data!=" ok")) {
                    ...
                    myApp.alert('Comunicado inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'comuncondominio'}); comuncondominio();});
                }
              });
        }else{
            // Salvando pdf no servidor
    ...
    function listPortaria(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                myApp.hideIndicator();
                myApp.alert('Erro ao carregar dados, tente novamente!', 'Conceito', function () { mainView.router.load({pageName: 'comunportaria'}); comunportaria();});
            }
        });
    }
        ...
        $.ajax($server+'functionAppResposta.php?', {
          ...
          .done(function(data) {
            if ((data!="ok") && (data!=" ok")) {
                ...
                myApp.hideIndicator();
                myApp.alert('Resposta inserida com sucesso!', 'Conceito', function () { mainView.router.back();});
            }
          });
}
            ...
            $.ajax($server+'functionAppComunPortaria.php?', {
              ...
              .done(function(data) {
                if ((data!="ok") && (data!=" ok")) {
                    ...
                    if (localStorage.getItem("portariaIdportaria")) {
                        myApp.alert('Comunicado inserido com sucesso!', 'Conceito', function () { window.location = "index.html";});
                    }else{
                        myApp.alert('Comunicado inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'comuncondominio'}); comunportaria();});
                    }
                }
              });
        }else{
            ...
            $.ajax($server+'functionAppComunMorador.php?', {
              ...
              .done(function(data) {
                if ((data!="ok") && (data!=" ok")) {
                    ...
                    myApp.alert('Comunicado inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'comuncondominio'}); comunmorador();});
                }
              });
        }else{
            // Salvando pdf no servidor
    ...
    myApp.confirm('Deseja deletar esse Banner?', function () {
        ...
        $.ajax({
            ...
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Banner excluido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'banner'}); banner(); myApp.closeModal('.popup.modal-in');});
        ...
        $.ajax($server+'functionAppBanner.php?', {
          ...
          .done(function(data) {
            if ((data!="ok") && (data!=" ok")) {
                ...
                myApp.hideIndicator();
                myApp.alert('Banner inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'banner'}); banner();});
            }
          });
}
    ...
    myApp.confirm('Deseja confirmar esse agendamento?', function () {
        ...
        $.ajax({
            ...
            if (data!="ok") {
                ...
                myApp.hideIndicator();
                myApp.alert('Agendamento confirmado com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'agendamentodeespaco'});agendamentodeespaco();});
            }
...
$$('#butinseriragendamento').on('click', function(){
    ...
    if (($$('#horainicoagendamento').val()!="00:00") &&  ($$('#horaterminoagendamento').val()!="00:00")) {
        if ($$('#horaterminoagendamento').val()<$$('#horainicoagendamento').val()) {
            myApp.alert('Hora término deve ser maior que hora início', 'Conceito'); 
        } else if ($$('#horaterminoagendamento').val()==$$('#horainicoagendamento').val()) {
             myApp.alert('Hora início e término devem ser diferentes', 'Conceito'); 
        } else{
            enviarespaco();
        }
    }else{
...
function enviarespaco()
{
        ...
        $.ajax($server+'functionAppEspaco.php?', {
          ...
          .done(function(data) {
            if ((data=="ok") || (data==" ok")) {
                myApp.hideIndicator();
                myApp.alert('Agendamento inserido com sucesso!', 'Conceito', function () { mainView.router.load({pageName: 'agendamentodeespaco'});agendamentodeespaco();});
                ...
                myApp.alert(data, 'Conceito', function () { mainView.router.load({pageName: 'agendamentodeespaco'});agendamentodeespaco();});           
            }
          });
}
